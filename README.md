...
7. PDF Intelligent Recognition (OCR)
   ...
   - After recognition is complete, the results will be displayed in Markdown format in the text box and automatically saved as a .md file with the same name.
